...
/**
 * Title: Archive
 * Slug: miles-veils-of-fate-tales-of-eldermoor-fc13d6a3/template-archive
 * Categories: hidden
 * Inserter: false
 */
?>
...
<div class="wp-block-group alignfull has-background" style="background-color:var(--wp--preset--color--c-void);padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:group {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}},"border":{"bottom":{"color":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dc-purple-deep)","width":"1px"},"style":"solid"},"padding":{"bottom":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="border-style:solid;border-bottom-color:var(--wp--preset--color--c-purple-deep);border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"className":"has-text-color","fontSize":"small","style":{"color":{"text":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dc-purple)"},"typography":{"fontFamily":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dfont-family\u002d\u002dcinzel-decorative)","textAlign":"center"}}} -->
<p class="has-text-align-center has-text-color has-small-font-size" style="color:var(--wp--preset--color--c-purple);font-family:var(--wp--preset--font-family--cinzel-decorative)">Archive</p>
<!-- /wp:paragraph -->

<!-- wp:query-title {"type":"archive","textAlign":"center","fontFamily":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dfont-family\u002d\u002dcinzel-decorative)","fontSize":"huge","style":{"color":{"text":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dc-gold)"}}} /-->

<!-- wp:term-description {"textAlign":"center","fontSize":"lg","style":{"color":{"text":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dc-ash)"}}} /--></div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-text-color has-lg-font-size" style="color:var(--wp--preset--color--c-ash)">No tales have been found in this corner of Eldermoor. The archive is silent.</p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
